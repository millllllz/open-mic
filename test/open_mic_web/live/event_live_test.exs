defmodule OpenMicWeb.EventLiveTest do
  use OpenMicWeb.ConnCase

  import Phoenix.LiveViewTest
  import OpenMic.EventsFixtures

  @create_attrs %{name: "some name", start_time: "2024-08-19T00:21:00"}
  @update_attrs %{name: "some updated name", start_time: "2024-08-20T00:21:00"}
